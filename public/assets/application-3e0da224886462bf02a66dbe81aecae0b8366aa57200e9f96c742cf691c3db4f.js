...
(function() {
  ...
  MathHammer.DistributionForm = (function() {
    function DistributionForm(props1) {
      ...
      this.add_roll = bind(this.add_roll, this);
      this.perform_calculation = bind(this.perform_calculation, this);
      window.view_model = this;
      if (!(this.ROLL_TYPES = this.props.ROLL_TYPES)) {
        throw new Error;
      }
      this.new_roll_type = ko.observable(this.ROLL_TYPES.first);
      window.ajax_params = this.ajax_params = {
      ...
      this.is_offensive = ko.computed((function(_this) {
        return function() {
          return _this.ajax_params.distribution_type() === 'offensive';
        };
      })(this));
      this.is_defensive = ko.computed((function(_this) {
        return function() {
          return _this.ajax_params.distribution_type() === 'defensive';
        };
      })(this));
    ...
    DistributionForm.prototype.perform_calculation = function(data, event) {
      console.log(ko.toJS(this.ajax_params));
      this.distribution('Loading...');
      $.post('/distributions', ko.toJS(this.ajax_params), (function(_this) {
        return function(data) {
          if (!!data.success) {
            _this.distribution(data.distribution);
            return $(".current-distribution")[0].scrollIntoView(true);
          } else {
            return _this.distribution(data.error);
          }
        };
      })(this));
    ...
    DistributionForm.prototype.add_roll = function() {
      return this.ajax_params.tests()[0].rolls.push(this.roll_to_add());
    };

    DistributionForm.prototype.add_before = function(data) {
      var array;
      array = this.ajax_params.tests()[0].rolls;
      return array.splice(array.indexOf(data), 0, this.roll_to_add());
    };

    DistributionForm.prototype.roll_to_add = function() {
      var new_test, params_to_add;
      new_test = {
        roll_type: this.new_roll_type()
      };
      ...
      return $.extend(new_test, params_to_add);
    };

    DistributionForm.prototype.remove_roll = function(roll) {
  ...
  $(function() {
    var parsed_props, props, target;
    target = $('#distribution-new');
    props = target.attr('knockout_props');
    parsed_props = !!props ? JSON.parse(props) : {};
    return ko.applyBindings(new MathHammer.DistributionForm(parsed_props), target[0]);
  });
